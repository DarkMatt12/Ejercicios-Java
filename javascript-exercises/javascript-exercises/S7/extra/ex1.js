...
const suma = videogames.reduce(function (accumulator, coso) { 
    if(coso.genders.includes("RPG")){
        return accumulator + coso.score ;
    }else{
        return accumulator;
    }
}, 0);
const xd = videogames.filter((coso) => {return coso.genders.includes("RPG")});
console.log(suma / xd);
